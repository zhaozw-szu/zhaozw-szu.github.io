import{_ as n,c as a,a as e,o as i}from"./app-DAv9eHwS.js";const l="/assets/02_F1_Comparison-CDnBiB62.png",p="/assets/01_Loss_Comparison-B2L5ftSl.png",d={};function c(r,s){return i(),a("div",null,[...s[0]||(s[0]=[e(`<p>​ 经过之前的训练我们的方法已经稳定得到结果，在这一节，我们对模型进行改进，为解码器加入跳跃连接，让编码器的每次分辨率信息与解码器相互联通，接下来将详细介绍，也就是老师提供的<code>3-skipConnect.py</code></p><p>​ 我们现有的方法在前向传播的过程如下：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-"><span class="line"><span>    def forward(self, x):</span></span>
